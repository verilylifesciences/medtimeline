...
var CardcontainerComponent = /** @class */ (function () {
    ...
    CardcontainerComponent.prototype.setUpDrag = function (dragulaService) {
        ...
        this.subs.add(dragulaService.drop('graphcards').subscribe(function (value) {
            ...
            Object(src_constants__WEBPACK_IMPORTED_MODULE_6__["recordGoogleAnalyticsEvent"])('moveCard', 'moveCard', (typeof elementDisplayed === 'string') ?
                elementDisplayed :
        ...
        html2canvas__WEBPACK_IMPORTED_MODULE_2___default()(document.body).then(function (canvas) {
            ...
            _this.saveDialogRef.afterClosed().subscribe(function (result) {
                ...
                if (result) {
                    ...
                    Object(src_constants__WEBPACK_IMPORTED_MODULE_6__["recordGoogleAnalyticsEvent"])('saveStaticSnapshot', 'save', new Date().toDateString());
                }
            });
        });
    };
    ...
    CardcontainerComponent.prototype.openSnackBar = function () {
        ...
        snackBarRef.onAction().subscribe(function () {
            ...
            Object(src_constants__WEBPACK_IMPORTED_MODULE_6__["recordGoogleAnalyticsEvent"])('undoDelete', 'deleteCard', Array.from(_this.recentlyRemoved.values()).toString());
        });
    };
    /**
...
/* harmony import */ var _theme_verily_colors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../theme/verily_colors */ "./src/app/theme/verily_colors.ts");
// Copyright 2018 Verily Life Sciences Inc.
//
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
var MultiGraphCardComponent = /** @class */ (function () {
    function MultiGraphCardComponent() {
        ...
        this.color = _theme_verily_colors__WEBPACK_IMPORTED_MODULE_5__["BLUE_GREY_500"]; // Default color for a card component.
        /** Hold an instance of this enum so the HTML template can reference it. */
        this.ChartType = _graphtypes_graph_graph_component__WEBPACK_IMPORTED_MODULE_4__["ChartType"];
        /**
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChildren"])(_graphtypes_graph_graph_component__WEBPACK_IMPORTED_MODULE_4__["GraphComponent"]),
...
/* harmony import */ var _fhir_resource_set__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./fhir-resource-set */ "./src/app/fhir-resource-set.ts");
...
var FhirHttpService = /** @class */ (function (_super) {
    ...
    FhirHttpService.prototype.getObservationsWithCode = function (code, dateRange, limitCount) {
        ...
        return this.smartApiPromise.then(function (smartApi) {
            return smartApi.patient.api.fetchAll(queryParams)
                ...
                return results
                    .map(function (result) {
                    return new _fhir_data_classes_observation__WEBPACK_IMPORTED_MODULE_11__["Observation"](result);
                })
                    // TODO(b/126775896): Determine which statuses to
                    // filter out.
                    .filter(function (result) { return result.status !==
                    _fhir_data_classes_observation__WEBPACK_IMPORTED_MODULE_11__["ObservationStatus"].EnteredInError; });
            }, 
        ...
        return this.smartApiPromise.then(function (smartApi) {
            return smartApi.patient.api.fetchAll(queryParams)
                ...
                return results
                    ...
                    return _fhir_resource_set__WEBPACK_IMPORTED_MODULE_12__["LabeledClass"].extractMedicationEncoding(result) === code;
                })
                    .map(function (result) {
                    try {
                        return new _fhir_data_classes_medication_administration__WEBPACK_IMPORTED_MODULE_9__["MedicationAdministration"](result);
                    }
                    catch (e) {
    ...
    FhirHttpService.prototype.getMedicationOrderWithId = function (id) {
        ...
        return this.smartApiPromise.then(function (smartApi) {
            return smartApi.patient.api
                ...
                .then(function (result) {
                return new _fhir_data_classes_medication_order__WEBPACK_IMPORTED_MODULE_10__["MedicationOrder"](result.data);
            }, 
    ...
    FhirHttpService.prototype.getMedicationAdministrationsWithOrder = function (id, code) {
        ...
        return this.smartApiPromise.then(function (smartApi) {
            return smartApi.patient.api.fetchAll(queryParams)
                .then(function (results) {
                results
                    .filter(function (result) { return _fhir_resource_set__WEBPACK_IMPORTED_MODULE_12__["LabeledClass"].extractMedicationEncoding(result) === code; })
                    .map(function (result) {
                    return new _fhir_data_classes_medication_administration__WEBPACK_IMPORTED_MODULE_9__["MedicationAdministration"](result);
                })
    ...
    FhirHttpService.prototype.getEncountersForPatient = function (dateRange) {
        ...
        return this.smartApiPromise.then(function (smartApi) { return smartApi.patient.api.fetchAll(queryParams)
            ...
            results =
                results
                    .map(function (result) {
                    return new _fhir_data_classes_encounter__WEBPACK_IMPORTED_MODULE_8__["Encounter"](result);
                })
        ...
        return this.smartApiPromise.then(function (smartApi) {
            ...
            return _this.http
                ...
                return results.map(function (result) {
                    return new _fhir_data_classes_diagnostic_report__WEBPACK_IMPORTED_MODULE_7__["DiagnosticReport"](result);
                });
            });
        }, function (rejection) {
            _this.debugService.logError(rejection);
    ...
    FhirHttpService = __decorate([
        ...
        __metadata("design:paramtypes", [_debugger_service__WEBPACK_IMPORTED_MODULE_6__["DebuggerService"], Object, _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]])
    ], FhirHttpService);
...
var LabeledSeries = /** @class */ (function () {
    ...
    LabeledSeries.getLegendInfoFromResult = function (status, isPositive) {
        if (isPositive) {
            ...
            return _clinicalconcepts_display_grouping__WEBPACK_IMPORTED_MODULE_0__["posOtherNB"];
        }
        else {
            if (status === _fhir_data_classes_diagnostic_report__WEBPACK_IMPORTED_MODULE_1__["DiagnosticReportStatus"].Preliminary) {
...
var CustomizableGraphComponent = /** @class */ (function (_super) {
    ...
    CustomizableGraphComponent.prototype.openDialog = function (timestamp, editedAnnotation) {
        ...
        this.dialogRef.afterClosed().subscribe(function (r) {
            if (r) {
                ...
                _this.generateChart();
                Object(src_constants__WEBPACK_IMPORTED_MODULE_5__["recordGoogleAnalyticsEvent"])('addEventCustomTimeline', 'customTimeline', new Date().toDateString());
            }
        });
    };
    /**
    ...
    CustomizableGraphComponent.prototype.addEditListener = function (annotation) {
        ...
        annotation.editIcon.onclick = (function (e) {
            ...
            Object(src_constants__WEBPACK_IMPORTED_MODULE_5__["recordGoogleAnalyticsEvent"])('editEventCustomTimeline', 'customTimeline', new Date().toDateString());
        });
    };
...
/* harmony import */ var src_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/constants */ "./src/constants.ts");
/* harmony import */ var _graph_graph_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../graph/graph.component */ "./src/app/graphtypes/graph/graph.component.ts");
/* harmony import */ var _linegraph_linegraph_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../linegraph/linegraph.component */ "./src/app/graphtypes/linegraph/linegraph.component.ts");
// Copyright 2018 Verily Life Sciences Inc.
//
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
/* harmony import */ var _setup_data_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../setup-data.service */ "./src/app/setup-data.service.ts");
// Copyright 2018 Verily Life Sciences Inc.
//
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
var SetupComponent = /** @class */ (function () {
    ...
    SetupComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_clinicalconcepts_resource_code_manager__WEBPACK_IMPORTED_MODULE_8__["ResourceCodeManager"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _setup_data_service__WEBPACK_IMPORTED_MODULE_10__["SetupDataService"],
...
var UI_CONSTANTS = {
    ...
    SAVE_TO_NOTE: 'Save a static image of this page to a PowerChart clinical note',
