...
export const PATIENT_ENCOUNTER = ['02/11/2019 – 02/17/2019 (patient encounter)'];

export const TIME_PERIODS = ['Last three months', 'Last month', 'Last seven days',
    'Last three days', 'Since midnight yesterday'];
...
export const SUBMENU_LABELS = [
    ...
    'Vancomycin and Gentamicin', 'Microbiology', 'Radiology'
];
...
export const SUBMENU_DIAGNOSTIC = [
    'Radiology'];
